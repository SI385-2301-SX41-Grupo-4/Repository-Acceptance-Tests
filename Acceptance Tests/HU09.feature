...
Then la aplicación mostrará un apartado limitado de configuraciones en el que se dispondrá de a lo más 2 
voces artificiales de prueba para la lectura de pictogramas
...
And presione el botón de “Configuraciones Avanzadas de Lectura”
Then el sistema mostrará automáticamente un apartado que permitirá el acceso ilimitado a configuraciones 
personalizadas que dispondrá de 4 voces artificiales a más para la lectura de los pictogramas
