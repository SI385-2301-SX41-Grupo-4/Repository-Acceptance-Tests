...
Then la aplicación mostrará un apartado en el que se dispondrá de una variedad de herramientas que permitan crear
 un nuevo pictograma de acuerdo al tipo de membresía al cual pertenezcan
...
Then el sistema mostrará automáticamente un apartado que dispondrá de una gran variedad de herramientas 
que permitan mejorar el pictograma que el usuario desee presentes en su catálogo
