...
Then se abrirá secuencialmente una variedad de instrucciones referidas al uso del aplicativo dentro de las diferentes categorías de membresía (Membresía Gratuita y Membresía Premium)
